...
ssh -i /home/ec2-user/KEYS/$image root@$IP -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no "mkdir -p /home/ec2-user/dest ; mkdir -p /home/ec2-user/src"

echo "copying stuff to $1"
scp -r -i /home/ec2-user/KEYS/$image -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no /home/ec2-user/pre-repo/$target/$image/* root@$IP:/home/ec2-user/src/

scp -r -i /home/ec2-user/KEYS/$image -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no /home/ec2-user/MariaDBManager-GPG-KEY.p* root@$IP:/home/ec2-user/
...
scp -i /home/ec2-user/KEYS/$image -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no /home/ec2-user/build-scripts/create_repo.sh root@$IP:/home/ec2-user/
...
scp -r -i /home/ec2-user/KEYS/$1 -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no root@$IP:/home/ec2-user/dest/* /home/ec2-user/repo/$target/$image/

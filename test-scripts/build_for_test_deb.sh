...
ssh -i /home/ec2-user/KEYS/$image -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no root@$BuildIP "cp -r /home/ec2-user/workspace/* /usr/local/skysql/maxscale/ ; cd /usr/local/skysql/maxscale/ ; cmake . -DSTATIC_EMBEDDED=Y -DGCOV=Y -DERRMSG=/usr/share/english/errmsg.sys -DEMBEDDED_LIB=/usr/lib/ $cmake_flags; make; make install "

...
ssh -i /home/ec2-user/KEYS/$image -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no root@$BuildIP "cp -r /home/ec2-user/workspace/* /usr/local/skysql/maxscale/ ; cd /usr/local/skysql/maxscale/_build/ ; cmake .. -DSTATIC_EMBEDDED=Y -DGCOV=Y $cmake_flags; make; make install "

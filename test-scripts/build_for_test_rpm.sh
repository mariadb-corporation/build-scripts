...
ssh -i /home/ec2-user/KEYS/$image -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no root@$BuildIP "cp -r /home/ec2-user/workspace/* $maxdir/ ; cd $maxdir/_build/ ; cmake .. -DSTATIC_EMBEDDED=Y -DGCOV=Y $cmake_flags; make; make install "
